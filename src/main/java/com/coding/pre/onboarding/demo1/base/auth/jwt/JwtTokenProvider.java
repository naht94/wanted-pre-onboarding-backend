...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(JwtTokenProperties jwtTokenProperties) {
        ...
        byte[] secretByteKey = Decoders.BASE64.decode(jwtTokenProperties.getSecret());
    ...
    public JwtToken generateToken(Authentication authentication) {
        ...
        Date accessTokenExpiresIn = new Date(now + jwtTokenProperties.getAccessTokenExpires());
        ...
        String refreshToken = Jwts.builder()
                .setExpiration(new Date(now + jwtTokenProperties.getRefreshTokenExpires()))
                .signWith(key, SignatureAlgorithm.HS256)
                .compact();
